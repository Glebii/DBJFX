...
public class EditEmployeeFormController {
    ...
    void initialize() {
    Employee employeeForEdit = EmployeeTableController.requiredEmployeeForEdit;
    firstNameField.setText(employeeForEdit.getFname());
    lastNameField.setText(employeeForEdit.getLname());
    ...
    sssnField.setText(employeeForEdit.getSuperssn().toString());
    dnumberField.setText(employeeForEdit.getDnumber().toString());
    }
