...
public class DepartmentsTableController {
    ...
    void deleteDepartment(MouseEvent event) throws IOException, SQLException {
        Integer departmentNumber = departmentsTable.getSelectionModel().getSelectedItem().getDnumber();
    ...
    Integer dnumber = departmentsTable.getSelectionModel().getSelectedItem().getDnumber();
